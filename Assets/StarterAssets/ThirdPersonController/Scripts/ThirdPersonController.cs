...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            {
                Debug.Log(playerIndex + ":" + _playerInput.devices[i].deviceId);
                if (_playerInput.devices[i].deviceId == playerIndex)
                {
                    _playerInput.devices[i].MakeCurrent();
                }
            }
        }
